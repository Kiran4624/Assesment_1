from manager.m_auth import add
from manager.m_auth import view
from manager.m_auth import update
from customer.c_auth import customer
...
def main():
    ...
    if role == '1':
        ...
        purchase =customer.purchase_fruits()
        print(purchase)
    else:
